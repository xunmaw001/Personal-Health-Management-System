    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品作用" prop="yaopinZuoyng">
                       <el-input v-model="ruleForm.yaopinZuoyng"
                                 placeholder="药品作用" clearable  :readonly="ro.yaopinZuoyng"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="药品作用" prop="yaopinZuoyng">
                           <el-input v-model="ruleForm.yaopinZuoyng"
                                     placeholder="药品作用" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yaopinZuoyng: [
                              { required: true, message: '药品作用不能为空', trigger: 'blur' },
                          ],
                   yaopinChengfen: [
                              { required: true, message: '药品成分不能为空', trigger: 'blur' },
                          ],
                   yaopinContent: [
