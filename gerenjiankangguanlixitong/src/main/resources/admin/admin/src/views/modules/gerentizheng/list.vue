        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gerenjiankangguanlixitong/upload/gerentizhengMuBan.xls"
                        >批量导入体检记录数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('gerentizheng','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="gerentizhengNum"
                                   header-align="center"
                                   label="当前身高">
                        <template slot-scope="scope">
                            {{scope.row.gerentizhengNum}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                id : null,
                yonghuId : null,
                gerentizhengNum : null,
                tizhongNum : null,
                shentiTypes : null,
                meishiPhoto : null,
                gerentizhengContent : null,
            ...
            json_fields: {
                //级联表字段
                     ...
                     '电子邮箱': 'yonghuEmail',
                //本表字段
                     '当前身高': "gerentizhengNum",
                     '当前体重': "tizhongNum",
                     '身体状况': "shentiValue",
                     '饮食照片': "meishiPhoto",
                     '下次体检时间': "gerentizhengTime",
                     '添加时间': "insertTime",
            },
