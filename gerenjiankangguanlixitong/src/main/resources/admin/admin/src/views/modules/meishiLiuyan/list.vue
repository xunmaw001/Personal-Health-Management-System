        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '食谱标题' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.meishiName" placeholder="食谱标题" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gerenjiankangguanlixitong/upload/meishiLiuyanMuBan.xls"
                        >批量导入健康食谱留言数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('meishiLiuyan','导入导出')"
        ...
        methods: {
            ...
            wuyong(id) {
                ...
                _this.$confirm(`确定    操作?`, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"
                    ...
                    _this.$http({
                        url: "meishiLiuyan/update",
                        method: "post",
                        data: {
                            id:id,
//                            meishiLiuyanTypes:meishiLiuyanTypes,
                        }
                    }).then(({data}) => {
                        if(data && data.code === 0){
