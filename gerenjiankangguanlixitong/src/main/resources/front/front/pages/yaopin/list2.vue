	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <button
                    ...
                    v-if="isAuth('yaopin','新增')" @click="onAddTap()" class="uniui-add">新增</button>
		</view>
	</view>
...
<script>
	export default {
		...
		async onShow() {
            ...
            this.categoryList = yaopinTypes.data.list
				...
				let params = {
                    ...
                    yaopinDelete: 1,
							...
							if (this.categoryName != 0) {
                                params.yaopinTypes = this.categoryName
                            }
